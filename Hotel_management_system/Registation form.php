...
<div class="container-fluid"> <!-- Primary Id-->
  <div class="container" >
    <div class="row">
      ...
      <div class="col-sm-6 " style="background-color:grey; border-radius:50px;">
        
        <h1 align="center"><b><font style="font-family: 'Libre Baskerville', serif;text-shadow:3px 3px #000;">Create New Account?</font></b></h1>
