...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
     <a href="index.php"> <img src="logo/logo.png"/width="160px"height="40px"style="margin-top:5px;"> </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="rating.php"title="Gallery">Rating</a></li>
        <li><a href="user_recomendatio.php"title="Gallery">Recommend</a></li>
      </ul>
      
      <ul class="nav navbar-nav navbar-right">
        <li class="navbar-brand">Welcome <?php echo $eid; ?></li>
