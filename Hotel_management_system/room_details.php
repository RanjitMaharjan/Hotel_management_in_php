...
while($r_res=mysqli_fetch_assoc($sql))
  {
  ?>
    <img src="image/rooms/<?php echo $r_res['image']; ?>"class="img-responsive thumbnail"alt="Image"id="img1" style="height: 300px;">
...
?>
    ...
    <h2 class="Ac_Room_Text">Room no <?php echo $res['room_no']; ?></h2>
    <h3 class="Ac_Room_Text">Rs.<?php echo $res['price']; ?>/-</h3>
