...
<center><img src="logo/profile.jpg"style="width:300px;height:180px;"class="img-circle"></center>
<div class="container"style="width:100%;">
  <form action="/action_page.php">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pwd" readonly="readonly" value="<?php echo $res['password']; ?>">
    </div>
  </form>
</div>
<?php 	
