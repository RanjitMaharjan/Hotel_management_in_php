...
if(isset($savedata))
{
  ...
  else
  {
   ...
   $sql="insert into room_booking_details(name,email,phone,address,room_type,check_in_date,check_in_time,check_out_date) 
  values('$name','$email','$phone','$address','$room_type','$cdate','$ctime','$codate')";
     ...
     <form class="form-horizontal" method="post">
       <div class="col-sm-6">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" value="<?php echo $result['address']; ?>"  class="form-control" name="address"  placeholder="Enter Your Address"required/>
              </div>
        </div>
        </div>
           ...
           while($result1= mysqli_fetch_assoc($sql1))
           {
            ...
            ?><option>
            <a href="room_details.php?room_id=<?php echo $result1['room_id']; ?>"><?php echo $result1['type']; ?></a><hr></option>
            <?php } ?>
               </select>
              </div>
              </div>
            ...
            <div class="form-group">
              <div class="row">
                 <div class="control-label col-sm-5"><h4>check in time</h4></div>
                   <div class="col-sm-7">
                    <input type="time" name="ctime" class="form-control" id="d1" required>
                  </div>
              </div>
            </div>
          </div>
           <div class="col-sm-6">
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="date" name="codate" class="form-control" id="d2" required>
                </div> 
              </div>
            </div>
          </div>
            ...
            <input type="submit"value="Booked" name="savedata" class="btn btn-danger center"required>
