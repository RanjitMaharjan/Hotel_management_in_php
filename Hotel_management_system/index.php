...
<div id="myCarousel" class="carousel slide" data-ride="carousel"> <!--Slider Image Start Here--> 
    ...
    <div class="carousel-inner" role="listbox">
	  ...
	  <div class="item active">
        <img src="<?php echo $path; ?> " style="width:100%;height:500px;" alt="Image">
...
<div class="container text-center">    
  <h1>Welcome To <font color="#a6e22b;"><b>ROADSTAR HOTEL</b></font></h1><hr><br>
  <div class="row">
	...
	<div class="col-sm-4">
      ...
      <p class="text-justify"><?php echo substr($r_res['details'],0,100); ?></p><br>
	    <a href="room_details.php?room_id=<?php echo $r_res['room_id']; ?>" class="btn btn-danger text-center">Details</a><br><br>
            </div>
        	<?php } ?>
  </div>
  </div>
